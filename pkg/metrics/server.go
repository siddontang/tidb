...
var (
	...
	CachedTableInvalidationPersistEvent *prometheus.CounterVec
	CachedTableInvalidationEnqueueFail  *prometheus.CounterVec
...
func InitServerMetrics() {
	...
	CachedTableInvalidationPersistEvent = metricscommon.NewCounterVec(
		prometheus.CounterOpts{
			Namespace: "tidb",
			Subsystem: "server",
			Name:      "cached_table_invalidation_persist_event_total",
			Help:      "Counter of cached-table invalidation events before and after persistence coalescing.",
		}, []string{LblType})
	CachedTableInvalidationEnqueueFail = metricscommon.NewCounterVec(
		prometheus.CounterOpts{
			Namespace: "tidb",
			Subsystem: "server",
			Name:      "cached_table_invalidation_enqueue_fallback_total",
			Help:      "Counter of cached-table invalidation enqueue fallback events.",
		}, []string{LblType})
