...
const (
	...
	// TiDBCachedTableInvalidationPullInterval controls the background replay polling interval in milliseconds.
	TiDBCachedTableInvalidationPullInterval = "tidb_cached_table_invalidation_pull_interval"
	// TiDBCachedTableInvalidationBatchSize controls the number of invalidation rows loaded per replay batch.
	TiDBCachedTableInvalidationBatchSize = "tidb_cached_table_invalidation_batch_size"
	// TiDBEnableCachedTableInvalidationAsyncPersist enables asynchronous persistence for invalidation logs.
	TiDBEnableCachedTableInvalidationAsyncPersist = "tidb_enable_cached_table_invalidation_async_persist"
	...
	TiDBCachedTableInvalidationLogGCBatchSize = "tidb_cached_table_invalidation_log_gc_batch_size"
...
const (
	...
	DefTiDBCachedTableInvalidationLogGCBatchSize            = 1024
...
var (
	...
	CachedTableInvalidationLogGCBatchSize            = atomic.NewInt64(DefTiDBCachedTableInvalidationLogGCBatchSize)
